...
const mensagensDeErro = {
    ...
    senha: {
        ...
        patternMismatch: 'A senha deve conter entre 8 e 20 caracteres, deve conter pelo menos uma letra maiuscula e minuscula, um numero e não deve conter simbolos.'
    },
    dataNascimento: {
        valueMissing: 'O campo de data de nascimento não pode estar vazio.',
        customError: 'Voce deve ter mais que 18 anos para se cadastrar.'
    },
    cpf: {
...
function validaDataNascimento(input) {
    ...
    if(!maiorQue18(dataRecebida)) {
        mensagem = 'Voce deve ter mais que 18 anos para se cadastrar.'
    }
